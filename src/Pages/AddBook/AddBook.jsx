    ...
    <div className="w-full min-h-screen px-6 pt-2 pb-10">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[var(--secondary-text)]">
          Fill in the details and upload a cover to add your book to the
          library.
        </p>
      </div>
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-6">
            ...
            <div
              onClick={() =>
                setFormData({ ...formData, popular: !formData.popular })
              }
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-[var(--secondary-text)]">
                  Shows in the Popular Books section on home page
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-64 flex flex-col gap-4 sticky top-10">
          <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-5 flex flex-col gap-4">
            <div>
              <div className="text-sm font-semibold text-[var(--primary-text)] mb-1">
                Cover image
              </div>
              <div className="text-xs text-[var(--secondary-text)]">
                Upload to make your book stand out
              </div>
            </div>
            ...
            {preview ? (
              <div className="relative">
                ...
                <div className="mt-2">
                  <div className="text-xs font-medium text-[var(--primary-text)] truncate">
                    {coverImage?.name}
                  </div>
                  <div className="text-xs text-[var(--secondary-text)]">
              ...
              <div className="w-full aspect-[3/4] bg-[var(--accent-light-1)] rounded-xl border border-dashed border-[var(--accent-bg)] flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-xs text-[var(--accent-bg)] font-medium">
                  No cover yet
                </span>
              </div>
            )}
          ...
          <div className="bg-[var(--accent-light-1)] border border-[var(--card-border)] rounded-2xl p-4 flex gap-3">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="text-[var(--accent-bg)] flex-shrink-0 mt-0.5"
            >
            ...
            <p className="text-xs text-[var(--secondary-text)] leading-relaxed">
              ...
              will feature it in the Popular Books section on the home page.
            </p>
          </div>
        </div>
        </div>
        ...
        <button
          type="submit"
          className="w-full py-3.5 rounded-2xl bg-[var(--accent-hover)] text-white font-semibold text-base hover:bg-[var(--nav-active)] transition-all duration-300 flex items-center border-white/25 border-2 justify-center gap-2"
        >
          Add book to library
          <svg
            xmlns="http://www.w3.org/2000/svg"
